...
component{
	// Layout Variables
	this.name 			= "typical";
	this.description 	= "A simple text oriented ContentBox layout";
	this.version		= "1.0";
	this.author 		= "Richard McKenna";
	this.authorURL		= "http://www.richard-mckenna.com";
	// Screenshot URL, can be absolute or locally in your layout package.
	this.screenShotURL	= "screenshot.png";

	this.settings = [
		{ name="addThis", defaultValue="", required=false, type="text", label="AddThis Profile ID", title="AddThis Profile ID" }
	];
}